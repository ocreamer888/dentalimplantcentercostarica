...
export default function AboutIntro() {
  ...
  return (
    <div id="1" className="relative overflow-hidden h-full md:min-h-[800px] bg-white flex items-center p-4 pt-20 md:p-12  justify-center z-40container mx-auto px-4 sm:px-6 lg:px-8 h-full min-h-screen">
