...
const CardThree = dynamic(() => import("../ui/CardThree"), {
  loading: () => (
    <div className="relative flex flex-col h-64 w-full rounded-3xl bg-gray-100 animate-pulse" aria-busy="true" aria-live="polite" />
  ),
});
