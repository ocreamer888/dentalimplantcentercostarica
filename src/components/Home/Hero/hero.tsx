...
const imagesToPreload = [
  ...
  return (
    <section className="relative flex flex-col lg:flex-row h-screen rounded-b-3xl overflow-hidden justify-center lg:justify-start px-4 lg:pl-20 items-center backdrop-blur-2xl z-10 mb-40 md:mb-8 bg-gradient-to-br from-purple-500 to-purple-800">
