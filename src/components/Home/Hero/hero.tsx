...
export default function Hero2() {
  ...
  const scrollToForm = () => {
    ...
    return (
    <section className="relative flex flex-col lg:flex-row h-[96vh] m-4 rounded-3xl flex-1 overflow-hidden justify-start pl-20 items-center backdrop-blur-2xl">
                    <Image 
      ...
      <Header />
        ...
        <div className="flex-1 flex flex-col bg-purple-900/80 backdrop-blur rounded-3xl md:p-8 md:my-8 items-center md:items-start justify-center gap-4">
          ...
          <p className="text-xl text-balance font-medium text-pretty text-center md:text-left text-white">
            Full-Arch Dental Implants from only <span className="text-green-400 text-3xl font-bold">$14,950</span> in Costa Rica – <span className="font-bold">The #1 Dental Tourism Destination</span>
            </p>
